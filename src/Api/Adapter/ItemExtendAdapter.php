<?php
namespace ItemExtend\Api\Adapter;
...
class ItemExtendAdapter extends AbstractEntityAdapter
{
    ...
    {
        return 'Mapping\Api\Representation\ItemExtendRepresentation';
    }

    public function getEntityClass()
    {
        return 'Mapping\Entity\ItemExtend';
    }
